        ...
        <div class="collapse navbar-collapse" id="navbarResponsive" >
          <ul class="navbar-nav ml-auto">
            <li class="nav-item" style="background-color: tomato;" >
              <a href="./dathang/${userId}.htm" class="nav-link white">  <i class="fa fa-shopping-basket"></i>Thanh Toán</a>
            </li>
            <!-- Chức năng Đăng kí -->
           <li class="nav-item" style="display: ${nguoidung}">
              ...
              <div class="btn-group">
               		<a href="user/signin.htm" class="nav-link dropdown-toggle white"   data-toggle="dropdown"> Đơn hàng của ${user} </a> 
