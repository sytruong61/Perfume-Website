...
<section class="section-main" style="background-color: #dd787d !important;" >   
	<h2 style="color:white;margin-left:15px;margin-top:15px">Danh Sách Đơn Hàng</h2>
					...
					<div class="card-header" style="padding:0" >
						...
						<div class="btn-group" style="float: right;z-index: 15">							       				
    						<c:if test="${u.key.trangThai==false}">
    							<a href="donhang/xacnhan/${u.key.id}.htm?btn-xacnhan" style="background-color:#c1272d; color: white; border-color:#c1272d"><button style="background-color:#c1272d; color: white" type="button" class="btn btn-warning" name = "btn-sua">Xác nhận</button> </a>						 															
							</c:if>
							<a href="donhang/xacnhan/${u.key.id}.htm?btn-xoa"><button style="background-color:#c1272d; color: white; border-color:#c1272d" type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal" name = "btn-xoa">Hủy</button> </a>
